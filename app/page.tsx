  ...
  return (
    <div className="flex h-[calc(100vh-1.5rem)] w-full bg-tertiary lg:bg-[url('/images/homeBanner.svg')] bg-no-repeat bg-contain bg-right-bottom bg-[length:800px] justify-start items-center">
       <div className="flex flex-col px-8 lg:px-24 gap-8 lg:w-1/2">
        <h1 className="text-primary font-bold text-4xl">WELCOME TO KLINIKCARE</h1>
        <h1 className="text-white font-bold text-6xl">Meet the Best <br/>Doctor</h1>
        <h2 className="text-primary font-bold text-4xl italic">“Inovasi untuk Kesehatan Anda Antrian Tanpa Stres!”</h2>
